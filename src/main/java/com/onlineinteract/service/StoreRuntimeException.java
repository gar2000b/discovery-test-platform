...
public class StoreRuntimeException extends RuntimeException {
	 ...
	 */
	public StoreRuntimeException(final String message, final Throwable cause, final Object... parameters) {
		super(message, cause);
	 ...
	 */
	public StoreRuntimeException(final Throwable cause, final Object... parameters) {
	 ...
	 * @param parameters optional parameters to message
	 */
	public StoreRuntimeException(final String message, final Object... parameters) {
