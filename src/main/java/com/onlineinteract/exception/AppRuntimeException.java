...
/**
 * This class extends java.lang.RuntimeException and is the base for all
...
public class AppRuntimeException extends RuntimeException {
	...
	/**
	 * Construct a new AppRuntimeException.
	 *
	 ...
	 */
	public AppRuntimeException(final String message, final Throwable cause, final Object... parameters) {
		super(message, cause);
	 ...
	 */
	public AppRuntimeException(final Throwable cause, final Object... parameters) {
	 ...
	 * @param parameters optional parameters to message
	 */
	public AppRuntimeException(final String message, final Object... parameters) {
